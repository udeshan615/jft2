...
import { HeaderAuthActions, HeroAuthActions } from '@/components/home/hero-auth-actions';

// Static page — no blocking Supabase on the server (huge win on Vercel free cold starts)
      ...
      <main>
        <section className="relative overflow-hidden">
          ...
          <div className="relative mx-auto max-w-2xl px-4 pb-8 pt-12 text-center sm:px-6 sm:pb-10 sm:pt-16">
            <Image
              ...
              height={144}
              priority
              className="mx-auto h-28 w-28 object-contain drop-shadow-lg sm:h-36 sm:w-36"
            />
          ...
          <div className="relative h-44 w-full overflow-hidden sm:h-56">
            ...
            >
              ...
              <path
                ...
                opacity="0.5"
              />
              <path d="M200 280 L480 70 L520 70 L800 280 Z" fill="url(#fuji)" />
              <path
        ...
        <section className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
          ...
          <div className="mt-8 flex justify-center">
            <Link href="/register" className="group w-full max-w-xs">
          ...
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            ...
            <div className="mt-8 grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
              {CATEGORIES.map((c) => {
                const Icon = c.icon;
                return (
                  <Link key={c.title + c.href} href="/register">
